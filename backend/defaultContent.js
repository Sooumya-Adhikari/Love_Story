// Default seed content - used on first run to populate MongoDB
...
const defaultContent = {
  ...
  videos: [
    { id: 'v1', title: 'Our Trip Recap', thumbnail: PLACEHOLDER_PHOTO('video-1', 800, 500), videoUrl: '' },
    { id: 'v2', title: 'Happy Birthday, Love', thumbnail: PLACEHOLDER_PHOTO('video-2', 800, 500), videoUrl: '' },
  ],
  letters: [
    {
      id: 'l1',
      ...
      body: 'My love, if you are reading this, take a breath. Whatever today has been, it does not change one thing: you are the softest, strongest, most wonderful person I know. I am so proud of you, and I am not going anywhere. — Always yours.',
    },
    {
      id: 'l2',
      title: 'One Year In',
      date: 'February 2023',
      body: 'A year ago I did not know your favourite song or how you take your tea. Now I cannot imagine my life without either. Thank you for choosing me, every single day. Here is to a hundred more years of this.',
    },
  ],
  quotes: [
